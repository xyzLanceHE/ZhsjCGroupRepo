...
void NormalCallback(TinyROS::SimpleObjectMessage<float> msg)
{
    std::cout << "normal callback: I am normal function, I received: " << msg.Value << std::endl;
}
...
public:
    ...
    void CallbackInObject(TinyROS::SimpleObjectMessage<float> msg)
    {
        std::cout << "object callback: I am a member function of " << this->Name << ", I received: " << msg.Value << std::endl;
    }

    static void StaticMemberFuntion(TinyROS::SimpleObjectMessage<float> msg)
    {
        std::cout << "static callback: I am a static member function of SampleClass, I received: " << msg.Value << std::endl;
    }
};
...
public:
    ...
    void operator()(TinyROS::SimpleObjectMessage<float> msg)
    {
        std::cout << "functional object callback: I am an object named " << this->Name << ", I received: " << msg.Value << std::endl;
    }
};
...
int main()
{
    ...
    try
    {
        ...
        TinyROS::Node::Init("Vision Subscriber");
    }
    ...
    TinyROS::MessageCallback<TinyROS::SimpleObjectMessage<float>> callback(5);
    ...
    try
    {
        ...
        visionSub = TinyROS::NewSubscriber<TinyROS::SimpleObjectMessage<float>>("vision", callback);
